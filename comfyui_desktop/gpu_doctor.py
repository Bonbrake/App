...
def detect_gpu_hardware(force_refresh: bool = False) -> dict:
    ...
    # 3. If still unknown or non-NVIDIA, try Windows WMI (WMIC / PowerShell)
    ...
    # 4. Check for DirectML package availability
    try:
    ...
    # 5. Compute recommended launch arguments & mode based on GPU & VRAM
