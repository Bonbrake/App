...
def _ensure_tcl_tk_env():
    _tcl = r"C:\Users\jakeb\AppData\Local\Programs\Python\Python311\tcl\tcl8.6"
    _tk = r"C:\Users\jakeb\AppData\Local\Programs\Python\Python311\tcl\tk8.6"
...
class ComfyUIApp:
    ...
    def _build_video_v2v_tab(self):
        ...
        self.v2v_ref_list = ctk.CTkLabel(sf, text="(no references yet)", font=self.FONT_NORMAL, text_color=TEXT_MUTED)
