...
CURATED_MODELS: List[Dict[str, Any]] = [
    ...
    {
        "id": "sd35_large",
        "name": "SD 3.5 Large (8B MMDiT)",
        "filename": "sd3.5_large.safetensors",
        "type": "checkpoint",
        "category": "Next-Gen MMDiT",
        "size_gb": 8.1,
        "description": "Stability AI flagship 8B multimodal diffusion transformer with superior anatomy, composition, and typography.",
        "url": "https://huggingface.co/stabilityai/stable-diffusion-3.5-large/resolve/main/sd3.5_large.safetensors",
        "fallback_url": "https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/resolve/main/sd3.5_large_fp8.safetensors",
        "vram_rec": "12GB+ VRAM",
        "badge": "FLAGSHIP",
        "source": "Curated",
    },
    {
        "id": "illustrious_pony",
        "name": "Illustrious XL / Pony V6",
        "filename": "ponyDiffusionV6XL_v6StartWithThisOne.safetensors",
        "type": "checkpoint",
        "category": "Anime & Digital Illustration",
        "size_gb": 6.5,
        "description": "State-of-the-art anime, stylized character concept art, vibrant game visuals, and expressive lighting.",
        "url": "https://civitai.com/api/download/models/290640?type=Model&format=SafeTensor",
        "fallback_url": "https://huggingface.co/AstraliteHeart/pony-diffusion-v6-xl/resolve/main/ponyDiffusionV6XL_v6StartWithThisOne.safetensors",
        "vram_rec": "8GB+ VRAM",
        "badge": "SOTA ANIME",
        "source": "Curated",
    },
    {
        "id": "wan21_video",
        "name": "Wan 2.1 Video (1.3B DiT)",
        "filename": "wan2.1_t2v_1.3B.safetensors",
        "type": "checkpoint",
        "category": "SOTA Video Diffusion",
        "size_gb": 3.8,
        "description": "High-fidelity open-weights text-to-video diffusion transformer model with cinematic temporal coherence.",
        "url": "https://huggingface.co/Wan-AI/Wan2.1-T2V-1.3B/resolve/main/diffusion_pytorch_model.safetensors",
        "fallback_url": "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_t2v_1.3B_bf16.safetensors",
        "vram_rec": "8GB+ VRAM",
        "badge": "SOTA VIDEO",
        "source": "Curated",
    },
    ...
    {
        "id": "nomos8k_4x",
        "name": "4x-Nomos8k Ultra Detail",
        "filename": "4x-Nomos8k.pth",
        "type": "upscaler",
        "category": "Upscaling Super-Resolution",
        "size_gb": 0.06,
        "description": "Advanced photographic and texture super-resolution for microscopic detail recovery and zero artifacting.",
        "url": "https://huggingface.co/uwg/upscaler/resolve/main/ESRGAN/4x_NMKD-Superscale-SP_178000_G.pth",
        "fallback_url": "https://huggingface.co/lokcx/4x-Ultrasharp/resolve/main/4x-UltraSharp.pth",
        "vram_rec": "2GB+ VRAM",
        "badge": "HIGH-RES",
        "source": "Curated",
    },
